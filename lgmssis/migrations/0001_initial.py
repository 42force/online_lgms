    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progoption', models.CharField(blank=True, choices=[('SPED', 'SPED'), ('GRADE SCHOOL', 'GRADE SCHOOL'), ('HOMESTUDY', 'HOMESTUDY'), ('CASA', 'CASA'), ('HIGH SCHOOL', 'HIGH SCHOOL')], default='CASA', help_text='Please select Program', max_length=20)),
                ('howdidyouhear', models.CharField(blank=True, choices=[('SPED', 'SPED'), ('GRADE SCHOOL', 'GRADE SCHOOL'), ('HOMESTUDY', 'HOMESTUDY'), ('CASA', 'CASA'), ('HIGH SCHOOL', 'HIGH SCHOOL')], default='FACEBOOK', help_text='How did you hear about us?', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty_users', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_students', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
