...
class CourseAttendance(models.Model):
    ...
    def __str__(self):
        return __str__(self.student) + " " + __str__(self.date) + " " + __str__(self.status)
...
class StudentAttendance(models.Model):
    student =  models.ForeignKey(Student, on_delete=models.CASCADE, related_name="student_attn", help_text="Start typing a student's first or last name to search")
    date = models.DateField(default=datetime.datetime.now)
    status = models.ForeignKey(AttendanceStatus, on_delete=models.CASCADE)
...
class AttendanceLog(models.Model):
    ...
    course = models.ForeignKey('lgmsschedule.Course', on_delete=models.CASCADE)
    asp = models.BooleanField(help_text="LGMS attendance, if unchecked this is for a homeroom")
    def __str__(self):
        return __str__(self.user) + " " + __str__(self.date)
