...
class DepartmentGraduationCredits(models.Model):
    ...
    class_year = models.ForeignKey('lgmssis.ClassYear', on_delete=models.CASCADE, help_text='Also applies to subsequent years unless a more recent requirement exists.')
