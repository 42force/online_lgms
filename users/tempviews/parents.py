...
def register_parents(request):
    if request.method == 'POST':
        ...
        if user_form.is_valid():
            ...
            return redirect('users/parents/parentssprofile.html')
    else:
        user_form = UserRegisterForm()
    return render(request, 'users/students/parentsregister.html', {'user_form' : user_form})
...
class ParentsInfoView(ListView):
    pass
